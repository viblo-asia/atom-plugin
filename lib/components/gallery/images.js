...
export default class Images {
    ...
    renderImage (image) {
        const img = new Img({ image })
        img.element.setAttribute('data-zoom-target', image.path)
        return img.element.outerHTML
    }
                    ...
                    _map(this.images, (image) => {
                        return image.path ? (
                            <figure class="gallery__image">
                                <div className="img" innerHTML={this.renderImage(image)}/>
