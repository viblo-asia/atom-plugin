...
export default class PublishForm {
    ...
    isCreate () {
        return this.textEditor.id === 'untitled'
    }
        ...
        return save(data)
            .then(({ data }) => {
                ...
                if (this.isCreate()) {
                    ...
                    this.textEditor.emitter.emit('did-destroy')
                    return open_post_editor(data.data.hash_id || data.data.slug)
                }

                return this.textEditor.save()
            })
            .catch((e) => {
